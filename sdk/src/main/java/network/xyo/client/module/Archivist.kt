...
import network.xyo.client.archivist.wrapper.ArchivistGetQueryPayload
import network.xyo.client.archivist.wrapper.ArchivistInsertQueryPayload
...
interface IArchivist<TConfig: ArchivistConfig, TParams : ArchivistParams<TConfig>, TResolver : ModuleResolver> : IModule<TConfig, TParams, TResolver>
