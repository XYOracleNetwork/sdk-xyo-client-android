...
class AccountTest {
    ...
    fun testAddress() {
        ...
        val signature = Bytes.bytesToHex(account.private.sign(testVectorHash))
    ...
    fun testAddressHexRoundTrip() {
        val privateBytes = Bytes.hexToBytes(testVectorPrivate)
        val privateHex = Bytes.bytesToHex(privateBytes)
